package net.FatCactis.smoothparticles.particle;

import net.minecraft.client.particle.ParticleTextureSheet;
import net.minecraft.client.particle.SpriteBillboardParticle;
import net.minecraft.client.world.ClientWorld;

public class NewGravityBlock extends SpriteBillboardParticle {
    protected NewGravityBlock(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
